...
- **Frontend**: React + TypeScript (Vite). **Status: Functional Implementation Found**.
  ...
  - _Note: Previous documentation incorrectly stated this was not started._
...
1.  **LLM Council with Division of Labour**:
    ...
    - _Mechanism_: Weighted voting based on reliability confidence.
...
2.  **Install & Run**:
    ...
    ```
    _Access API docs at http://localhost:8000/docs_
...
1.  **Install & Run**:
    ...
    npm run dev
    ```
    _Access Dashboard at http://localhost:3000_
...
_This document was consolidated on 2025-12-20 to replace scattered status files._
